...
const zhCN: Record<TranslationKeys, string> = {
  ...
  /* ── 隐私政策 ── */
  privacy_title: "隐私政策",
  privacy_updated: "最后更新：2026年2月23日",
  privacy_dataCollection: "数据收集",
  privacy_dataCollectionDesc: "Kinolu 在你的设备上本地处理所有照片。除非你明确启用云同步，否则我们不会上传、存储或访问你的照片。",
