const en = {
  ...
  landing_step1Title: "Import or Shoot",
  landing_step1Desc: "Open any photo in the Editor, or use the Camera to shoot with live preset preview.",
  landing_step2Title: "Choose Your Style",
  landing_step2Desc: "Pick a reference photo to match its colors, or choose from 12 built-in film presets like Kodak Portra, Fuji Classic Chrome, and more.",
  landing_step3Title: "One-Tap Apply",
  landing_step3Desc: "Kinolu instantly applies the color grade — whether transferred from a reference image or from a film preset.",
  landing_step4Title: "Fine-Tune & Export",
  landing_step4Desc: "Dial in the look with XY pad, curves, and HSL. Then save your photo, share it, or export as a .cube LUT for other apps.",
  landing_galleryLabel: "Gallery",
  landing_galleryTitle: "See What's Possible",
