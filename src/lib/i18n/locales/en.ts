const en = {
  ...
  landing_showcaseSubtitle: "See what Kinolu can do — import a reference photo and transfer its color palette to yours.",
  landing_showcase_original: "Original",
  landing_showcase_reference: "Reference",
  landing_showcase_result: "Result",
  landing_showcase_flowDesc: "Import a reference photo you love, and Kinolu transfers its color palette to your image — one tap, real-time preview.",
  landing_showcase_presetsNote: "Also includes 12 built-in film presets: Fuji PROVIA, Classic Chrome, Velvia, Kodak Portra, Gold & more",
