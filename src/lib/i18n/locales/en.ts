const en = {
  ...
  terms_billingDesc: "Kinolu Pro subscriptions are billed through Stripe. Monthly and annual plans renew automatically unless canceled before the next billing cycle. Lifetime plans are a one-time purchase with no recurring charges. Prices are shown in USD.",
