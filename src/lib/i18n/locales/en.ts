const en = {
  ...
  landing_step1Desc: "Open any photo from your device in the editor.",
  landing_step2Title: "Add a Reference",
  landing_step2Desc: "Pick a photo whose color grade you want to match.",
  landing_step3Title: "One-Tap Transfer",
  landing_step3Desc: "Kinolu analyzes and transfers the color palette instantly.",
  landing_step4Title: "Fine-Tune & Save",
  landing_step4Desc: "Adjust with XY pad, curves, HSL — then save or export a LUT.",
  ...
  landing_finalDesc: "No download needed. Works right in your browser.",
