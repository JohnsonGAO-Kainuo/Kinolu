const en = {
  ...
  sub_free: "Free",
  sub_current: "CURRENT",
  sub_free1: "Unlimited local presets",
  sub_free2: "All color transfer methods",
  sub_free3: "LUT export (.cube)",
  sub_free4: "Full editor suite",
  sub_pro: "Pro",
  sub_proPrice: "$4.99/mo",
  sub_pro1: "Everything in Free",
  sub_pro2: "Cloud sync for presets",
  sub_pro3: "Batch processing",
  sub_pro4: "Priority support",
