...
const LS_KEY = "kinolu_builtin_luts_v5"; // v5: vintage street sample photo (rich colors)
...
export async function ensureBuiltinLuts(): Promise<string[]> {
  ...
  for (const oldKey of ["kinolu_builtin_luts_v1", "kinolu_builtin_luts_v2", "kinolu_builtin_luts_v3", "kinolu_builtin_luts_v4"]) {
