...
/* ═══════════════════════════════════════════════════════════
   ...
   Rich marketing page + integrated community section.
   ═══════════════════════════════════════════════════════════ */
...
/* Before / After showcase slots — placeholder images until real ones are provided */
...
export default function LandingPage() {
  ...
  /* ── Publish post (image is optional) ── */
  const handlePublish = async () => {
    ...
    try {
      ...
      if (imageFile) {
        imageUrl = await uploadCommunityImage(user.id, imageFile);
      }
  ...
  return (
    <div className="relative w-full min-h-screen bg-black text-white overflow-y-auto">
      {/* ═══ Nav Bar ═══ */}
      <nav className="fixed top-0 left-0 w-full z-50 safe-top bg-black/70 backdrop-blur-xl border-b border-white/[0.04]">
      ...
      <section className="relative w-full h-screen flex flex-col items-center justify-center px-6 text-center">
        ...
        <div className="relative z-10 max-w-2xl">
          <h1 className="text-[36px] sm:text-[48px] md:text-[64px] font-black tracking-[4px] sm:tracking-[6px] leading-[1.1] uppercase">
            {t("landing_heroTitle")}
          </h1>
        ...
        <div className="grid grid-cols-2 sm:grid-cols-3 gap-5">
          {FEATURES.map((f) => (
            ...
            >
              ...
              <h4 className="text-[13px] font-semibold tracking-wide mb-1.5">
                {t(f.key)}
              </h4>
      ...
      <section id="showcase" className="max-w-6xl mx-auto px-5 py-20 scroll-mt-16">
        <h2 className="text-[10px] tracking-[4px] text-white/30 uppercase text-center mb-2">
          ...
          {SHOWCASE_PAIRS.map((pair, i) => (
            <div key={i} className="group relative">
              <div className="rounded-2xl overflow-hidden aspect-[4/3] bg-white/[0.03] border border-white/[0.06] hover:border-white/[0.12] transition-all">
                {/* TODO: Replace with real before/after images */}
                <img
                  src={pair.src}
                  alt={t(pair.label)}
      ...
      {/* ═══ How It Works ═══ */}
      <section id="how-it-works" className="max-w-4xl mx-auto px-5 py-20 scroll-mt-16">
        <h2 className="text-[10px] tracking-[4px] text-white/30 uppercase text-center mb-2">
          {t("landing_howLabel")}
        </h2>
          ...
          {STEPS.map((step) => (
            <div key={step.num} className="flex gap-4 items-start">
              <div className="shrink-0 w-12 h-12 rounded-xl bg-white/[0.04] border border-white/[0.08] flex items-center justify-center">
                <span className="text-[16px] font-black text-white/20 tracking-tight">
                  {step.num}
                </span>
              </div>
              <div>
                <h4 className="text-[14px] font-semibold tracking-wide mb-1">
                  {t(step.key)}
                </h4>
      ...
      {/* ═══ Community Section ═══ */}
      <section id="community" className="max-w-6xl mx-auto px-5 py-24 scroll-mt-16">
        <h2 className="text-[10px] tracking-[4px] text-white/30 uppercase text-center mb-2">
          {t("community_title")}
        </h2>
        ...
        {/* Create post form — image is optional */}
        {showForm && (
        ...
        {loadingPosts ? (
          ...
          <p className="text-center text-[13px] text-white/25 py-16">
            {t("community_noPostsYet")}
          </p>
        ) : (
            ...
            {posts.map((post) => (
              ...
              >
                ...
                <div className="p-4">
                  ...
                  >
                    <h4 className="text-[14px] font-semibold tracking-wide line-clamp-1">
                      {post.title}
                    </h4>
                  </button>
                  {post.description && (
      ...
      <footer className="border-t border-white/[0.06] py-10 px-5">
        <div className="max-w-6xl mx-auto flex flex-col sm:flex-row items-center justify-between gap-4">
          <div className="flex items-center gap-2">
            ...
            <span className="text-[11px] tracking-[3px] text-white/40 font-bold">
              KINOLU
            </span>
          </div>
