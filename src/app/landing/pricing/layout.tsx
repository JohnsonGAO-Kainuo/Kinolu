...
export const metadata: Metadata = {
  ...
  description:
    "Kinolu is free to use with 3 AI color transfers per day. Upgrade to Pro for unlimited transfers, all 12 film presets, and priority support. Plans from $2.99/month.",
  keywords: [
  ...
  openGraph: {
    ...
    description: "Free tier with 3 daily transfers. Pro from $2.99/mo for unlimited AI color grading & all 12 film presets.",
